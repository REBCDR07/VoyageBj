...
export const Ticket: React.FC<TicketProps> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div
        ref={ticketRef}
        className="bg-white w-[800px] h-[300px] rounded-3xl shadow-2xl overflow-hidden relative print:shadow-none flex"
      >
        {/* Left Section: Main Info */}
        <div className="flex-[2.5] p-8 relative flex flex-col justify-between bg-white">
      ...
      <div className="mt-6 flex gap-4 no-print" data-html2canvas-ignore="true">
        <button
          onClick={handleDownloadPDF}
          disabled={!!isDownloading}
          className="flex items-center justify-center space-x-2 px-6 py-3 bg-[#008751] text-white rounded-xl text-sm font-bold hover:bg-[#006b40] transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-green-200"
        >
        ...
        <button
          ...
          disabled={!!isDownloading}
          className="flex items-center justify-center space-x-2 px-6 py-3 bg-gray-900 text-white rounded-xl text-sm font-bold hover:bg-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-gray-200"
        >
